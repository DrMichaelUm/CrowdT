...
namespace AppsFlyerSDK
{
    public class AppsFlyer : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="devKey">
        ///     AppsFlyer's Dev-Key, which is accessible from your AppsFlyer account under 'App Settings' in the
        ///     dashboard.
        /// </param>
        ...
        {
            if (gameObject != null) CallBackObjectName = gameObject.name;
        ...
        ///     Once the API is called a sessions will be immediately sent, and all background forground transitions will send a
        ///     session.
        /// </summary>
        ...
        /// <summary>
        ///     Setting your own customer ID enables you to cross-reference your own unique ID with AppsFlyer’s unique ID and the
        ///     other devices’ IDs.
        ///     This ID is available in AppsFlyer CSV reports along with Postback APIs for cross-referencing with your internal
        ///     IDs.
        /// </summary>
        ...
        ///     Allows the developer to access the user attribution data in real-time for every new install, directly from the SDK
        ///     level.
        ...
        /// </code>
        /// </example>
        public static void attributeAndOpenStore(string appID, string campaign, Dictionary<string, string> userParams,
        ...
        /// <summary>
        ///     The LinkGenerator class builds the invite URL according to various setter methods which allow passing on additional
        ...
        {
            var args = new DeepLinkEventsArgs(response);
        ...
        private static AppsFlyerRequestEventArgs parseRequestCallback(string response)
        {
            ...
            try
            {
                var dictionary = CallbackStringToDictionary(response);
        ...
        {
            Debug.Log(string.Format("AppsFlyer_Unity_v{0} {1} called with {2}", kAppsFlyerPluginVersion, methodName,
                str));
        }
    }
